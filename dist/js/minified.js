...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=37df6e7c0ad31f02279402b1e60d810a)
 * Config saved to config.json and https://gist.github.com/37df6e7c0ad31f02279402b1e60d810a
 */
...
myRuns.run([
    "$rootScope", "$state", "$stateParams", "$http", "config", function ($rootScope, $state, $stateParams, $http, config) {
        ...
        $rootScope.pageLocation = {
            ...
            "portfolio": { categoryID: 6, subcategoryID: 1, pageTitle: "Portfolio" },
...
app.constant('config', {
    vDate: 170122,
    appName: 'Malton Coachworks',
    appVersion: 1.0,
    isSearchable: false,
    apiUrl: 'http://www.maltoncoachworks.co.uk',
    imgDir: 'http://www.maltoncoachworks.co.uk/images_cms/',
    imgDirLarge: 'http://www.maltoncoachworks.co.uk/images_cms/large/',
    imgDirThumbs: 'http://www.maltoncoachworks.co.uk/images_cms/thumbs/',
    externalSite: 'http://www.classicandsportscar.ltd.uk',
    externalSiteImgDir: 'http://www.classicandsportscar.ltd.uk/images_catalogue/'
});
/* app-factory.js */
...
/* directives.js */
myDirectives.directive('introBar', ['config', function (config) {
    return {
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('features', ['config', function (config) {
    return {
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('slideshowBar', ['config', function (config) {
    return {
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('itemsList', ['config', function (config) {
    return {
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('blockShared', ['config', function (config) {
    return {
        scope: {
            blockType: '@',
            blockTitle: '@'
...
myDirectives.directive('contactForm', ['config', function (config) {
    return {
        scope: true,
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('searchForm', ['config', function (config) {
    return {
        scope: false,
        restrict: 'E',
        replace: true,
...
myDirectives.directive('searchResultsTags', ['config', function (config) {
    return {
        scope: {
            resultsCount: '=',
            resultsTagThreshold: '=',
...
myDirectives.directive('scrollLoad', ['$compile', function($compile) {
  return {
    restrict: 'A',
    link: function(scope, element, attrs) {
...
myDirectives.directive('headerBar', ['config', function (config) {
    return {
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('footerBar', ['config', function (config) {
    return {
        replace: true,
        restrict: 'AE',
...
myDirectives.directive('bannerBar', ['config', function (config) {
    return {
        scope: {
            bannerCarousel: '=',
            bannerText: '@',
...
myControllers.controller('block_custom', ['$scope', '$rootScope', '$controller', 'myFactory', function ($scope, $rootScope, $controller, myFactory) {
    $scope.data = myFactory.data;
    $scope.title = 'test';
}]);

myControllers.controller('block_1Ctrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
...
myControllers.controller('block_2Ctrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
...
myControllers.controller('block_3Ctrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
...
myControllers.controller('contactCtrlForm', ['$scope', '$http', function ($scope, $http) {
    $scope.result = 'hidden'
    $scope.resultMessage;
...
myControllers.controller('itemGetSetCtrl', ['$scope', '$http', '$rootScope', 'myFactory', function ($scope, $http, $rootScope, myFactory) {
    $scope.data = myFactory.data;
...
myControllers.controller('itemDetailsCtrl', ['$scope', '$sce', '$rootScope', '$http', '$log', 'myFactory', '$stateParams', 'config', '$controller', function ($scope, $sce, $rootScope, $http, $log, myFactory, $stateParams, config, $controller) {
    //$scope.data = myFactory.data;
...
myControllers.controller('portfolioListCtrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
...
myControllers.controller('testimonialsListCtrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
...
myControllers.controller('servicesListCtrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
...
myControllers.controller('featuresListCtrl', ['$scope', '$rootScope', '$controller', function ($scope, $rootScope, $controller) {
    $rootScope.activeCategory = "services";
    $scope.jsonKey = 'intro_services';
    $controller('itemGetSetCtrl', {$scope: $scope});
    $scope.jsonKey = null;
...
myControllers.controller('dynamicsCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {

}]);

myControllers.controller('banner_carouselCtrl', ['$scope', '$rootScope', '$controller', 'config', function ($scope, $rootScope, $controller, config) {    
...
myControllers.controller('navCtrl', ['$scope', '$rootScope', '$controller', '$http', '$location', 'buildSQLService', '$filter', '$stateParams', function ($scope, $rootScope, $controller, $http, $location, buildSQLService, $filter, $stateParams) {
...
myControllers.controller('headCtrl', ['$scope', 'myFactory', '$rootScope', function ($scope, myFactory, $rootScope) {
    $scope.data = myFactory.data;
...
myControllers.controller('searchCtrlXXXX', ['$scope', '$http', function($scope, $http) {
